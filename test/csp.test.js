...
describe('extensions', function() {
  describe('#tryCloseAll', function() {
    it('should close all channels in the given channel map object', function(
      done
    ) {
  ...
  describe('#multConnect', function() {
    ...
    it('should invoke error handler when mult receives error message', function(
      done
    ) {
      let takePool = { x: chan() }, subscribe = multConnect('x', takePool)
  ...
  describe('#beginPolling', function() {
    it('should poll and call handler synchronously when data is available', function(
      done
    ) {
    ...
    it('#1 should call error handler when error message is returned from channel', function(
      done
    ) {
    ...
    it('#2 should call error handler when error message is returned from channel', function(
      done
    ) {
      let fn = () => ++i
    ...
    it('should invoke same handler for multiple channels (array)', function(
      done
    ) {
  ...
  describe('#endPolling', function() {
    ...
    it('should end polling for the process identified by provided key', function(
      done
    ) {
      let co = { x: chan(), y: chan() }
      let i = 0, fn = () => ++i, h = { x: fn, y: fn }
